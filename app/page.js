        ...
        <>
            <main className="w-full xl:flex hidden  flex-row  max-h-[100vh] h-full">
                ...
                <div className="absolute bottom-0 flex justify-end items-end flex-col right-0 p-5">
                    <a target="_blank" href="https://waleeddotdev.netlify.app" className=" underline  opacity-50 hover:opacity-90 transition-opacity ">
                        Made by Waleed Nasir with <span className="text-red-600">❤</span>
                    </a>
                    <a target="_blank" href="https://github.com/waleeddotdev/Snappet" className=" underline  opacity-50 hover:opacity-90 transition-opacity ">
